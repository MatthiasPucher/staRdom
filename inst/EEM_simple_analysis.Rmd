...
if(metadata != FALSE){
  ...
  mutate_at(vars(one_of(col_samples)),make.names) %>%
...
if(absorbance_dir != FALSE){
  abs_data <- absorbance_read(absorbance_dir)
}
...
eem_checkdata(eem_list,abs_data,meta,metacolumns = c(col_dilution, col_cuv_len, col_raman_area), error = TRUE)
