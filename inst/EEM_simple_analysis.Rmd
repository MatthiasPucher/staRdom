...
```{r, include=FALSE}
###################################################
#### Version 1.0.12 of EEM_simple_analysis.Rmd ####
###################################################
...
# Are your samples generic csv files? Set FALSE, if you use files from Varian Cary Eclipse, Horiba Aqualog, Horiba Fluoromax-4 or Shimadzu instruments
generic_csv = TRUE
...
if(generic_csv){
      eem_list <- eem_read_csv(sample_dir,recursive=TRUE)
  } else {
