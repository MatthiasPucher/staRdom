...
The data is saved in a folder accesible by `system.file("extdata/fluorescence",package = "staRdom")`.
...
Plot created model's components. You can see the models fits and the components (rows) according to models with different numbers of components (columns) in 2 different views. 
