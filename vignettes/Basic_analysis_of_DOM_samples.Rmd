...
The script is running in R environment [@r_development_core_team_r:_2019]. Using a graphical user interface like RStudio (https://rstudio.com/) can help beginners to get into it.
