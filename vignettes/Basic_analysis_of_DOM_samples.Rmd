...
If samples were diluted before the spectroscopic measurements, the dilution factor can be set here and the sample will be corrected accordingly. As an example a dilution factor of 10 means a 1:10 dilution (1 part sample and 9 parts MilliQ). By setting `dilution = "meta"`, data from the meta table is used and each sample can be diluted differently.
